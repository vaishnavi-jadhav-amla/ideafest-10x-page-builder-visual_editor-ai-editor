...
export default async function BlogListPage({ searchParams }: Readonly<{ params: { id: number }; searchParams: ISearchParams }>) {
  ...
  return (
    ...
    >
      <Client data={pageStructure.data} themeName={themeName || ""} configType="blog-list" />
    </NextIntlClientProvider>
  );
}
