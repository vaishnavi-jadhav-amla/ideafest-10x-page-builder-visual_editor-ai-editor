  ...
  [
    "header",
    {
      ...
      removeComponentKeys: [
        ...
        {
          categoryKey: "znodeWidgets",
          componentKeys: ["BannerSlider", "CategoriesCarousel", "OfferBanner", "ProductsCarousel","BrandsCarousel", "AdSpace", "HomePagePromo", "Image", "Video", "NewsLetter", "FormWidget"],
        },
        {
  ...
  [
    "footer",
    {
      ...
      removeComponentKeys: [
        ...
        {
          categoryKey: "znodeWidgets",
          componentKeys: ["BannerSlider", "CategoriesCarousel", "OfferBanner", "ProductsCarousel","BrandsCarousel", "AdSpace", "HomePagePromo", "Ticker"],
        },
        {
          categoryKey: "uiWidgets",
          componentKeys: ["ButtonGroup", "TextImage"],
        },
      ],
      disabled: true,
    },
